...
export let options = {
    vus: 1200,        // 동시 사용자 500명
    duration: '1s',  // 1초 동안 반복
    thresholds: {
        // 95th 퍼센타일 응답시간이 5초 이내여야 테스트 통과
...
export function setup() {
    ...
    const createRes = http.post(
        'https://api.zapply.site/v1/project/create',
        '',    // 빈 바디
        authHeaders
    );
...
export default function (data) {
    ...
    group('2) 페이스북 캐러셀 미디어 발행', () => {
        ...
        const carouselRes = http.post(
            `https://api.zapply.site/v1/posting/facebook/${projectId}/carousel`,
    ...
    //         `https://api.zapply.site/v1/posting/3189/carousel/reschedule?snsType=FACEBOOK`,
